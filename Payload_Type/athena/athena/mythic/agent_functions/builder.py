...
class athena(PayloadType):
    ...
    wrapped_payloads = ["service_wrapper", "scarecrow_wrapper"]  # if so, which payload types. If you are writing a wrapper, you will need to modify this variable (adding in your wrapper's name) in the builder.py of each payload that you want to utilize your wrapper.
